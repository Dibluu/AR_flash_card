...
def return_card():
    ...
    canvas.itemconfig(canvas_ar_word, text=random_ar_word["French"], fill="white")
...
def change_word_right():
    ...
    df = arab_word[["Arabic", "French"]]  # Chargez à la fois les mots arabes et français
    ...
    known_word_entry = f"{random_ar_word['Arabic']} {random_ar_word['French']}\n"
...
canvas_score = canvas.create_text(100, 50, text=f"{SCORE}/1000 mots connus", font=("Ariel", 15, "bold"), fill="black")
